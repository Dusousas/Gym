    ...
    return (
        <>
            ...
            <nav className="hidden lg:block">
                <ul className="flex gap-6 items-center text-lg uppercase  text-white">
                    <li>
                        <button 
            ...
            <div className="lg:hidden">
                <button
                    ...
                    className="text-3xl text-RedP focus:outline-none relative z-50"
                    type="button"
                ...
                <nav
                    className={`fixed top-0 right-0 h-screen w-full text-H1  bg-white shadow-md z-40 flex flex-col items-center justify-center transition-transform duration-300 ${
                        isOpen ? "translate-x-0" : "translate-x-full"
                    }`}
                >
                    <ul className="flex flex-col items-center text-H1 gap-8 text-lg text-BrownP">
                        ...
                        <li className="text-H1 ">
                            <button 
                                onClick={() => handleNavigation('/Factore')}
                                className="hover:opacity-70 transition-opacity uppercase cursor-pointer"
                                type="button"
                            >
                                Nossa Fábrica
